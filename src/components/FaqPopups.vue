...
const { modal, isOpenNewEntry, errorMessage, isOpenDel, isOpenEdit, faqName,
    amount,
    course,
    question, answer,
    courses, delId, editId } = storeToRefs(faqStore);
const { closePopup, getCourses, insertFaq,
    deleteFaq,
    editFaq } = faqStore;
    ...
    <Teleport to="#modal">
        ...
        <Transition name="modal">
            <div class="fixed top-0 left-0 z-[9999] w-[100vw] h-[100%] flex justify-center items-center bg-black bg-opacity-50"
                ...
                <div class="z-20" ref="modal">
                    <form class="bg-white p-4 rounded-lg w-[300px]" @submit.prevent="insertFaq">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="" id="" cols="0" rows="5" v-model="question" placeholder="Write Question" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="" id="" cols="0" rows="5" v-model="answer" placeholder="Write Answer" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
                                <span class="text-red-700 text-sm">{{ errorMessage }}</span>
        ...
        <Transition name="modal">
            <div class="fixed top-0 left-0 z-[9999] w-[100vw] h-[100%] flex justify-center items-center bg-black bg-opacity-50"
                ...
                <div class="z-20" ref="modal">
                    <form class="bg-white p-4 rounded-lg w-[300px]" @submit.prevent="editFaq(editId)">
                        <span class="flex justify-end w-full pr-2">
                            <span class="fa-solid fa-xmark hover:cursor-pointer" @click="closePopup"></span>
                        </span>
                        <div class="p-4">

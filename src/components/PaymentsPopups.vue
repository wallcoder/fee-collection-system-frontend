...
const { modal, isOpenNewEntry, errorMessage, isOpenDel,  lName,
     ...
     delId,  } = storeToRefs(paymentStore);
const { closePopup, getCourses, insertPayment,
    deletePayment,
     } = paymentStore;
        ...
        <Transition name="modal">
            <div class="fixed top-0 left-0 z-[9999] w-[100vw] h-[100%] flex justify-center items-center bg-black bg-opacity-50"
                ...
                <div class="z-20" ref="modal">
                    <form class="bg-white p-4 rounded-lg w-[300px]" @submit.prevent="insertPayment">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="paymentName" v-model="fName" value=""
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="paymentName" v-model="lName" value=""
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <div class="mb-5">
                                ...
                                <input type="email" id="paymentName" v-model="email" value=""
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <div class="mb-5">
                                ...
                                <select type="text" id="paymentName" v-model="type" 
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    required placeholder="Enter Email">
                                    <option value="Head Payment">Head Payment</option>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="number" id="paymentName" v-model="phone" value=""
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    required placeholder="Enter Email" />
                                <span class="text-red-700 text-sm">{{ errorMessage }}</span>
            ...
            <div class="fixed top-0 left-0 z-[9999] w-[100vw] h-[100%] flex justify-center items-center bg-black bg-opacity-50"
                ...
                <div ref="modal" class="bg-white p-4 rounded-lg w-[300px] flex flex-col items-center">
                    ...
                    <div class="flex  w-full justify-center">
                        <button @click="deletePayment(delId)"

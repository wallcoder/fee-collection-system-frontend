...
import FaqsTable from "../components/FaqTable.vue";

import Button from '../components/Button.vue';
import SkeletonLoader from '../components/SkeletonLoader.vue'
import Error from "../components/Error.vue"
import FaqsPopup from '../components/FaqPopups.vue'
...
watch(search, (newValue) => {
    if (!newValue) {
        ...
        getFaqs(false, 1, newValue);
        filteredItems.value = items.value.filter(faq =>
            faq.question.toLowerCase().includes(newValue.toLowerCase()) ||
            faq.faq_id.toString().includes(newValue)
        );
    }
});
        ...
        <div v-else>
            <div>
                ...
                <section class="flex flex-col items-center w-[100%] h-[85vh]  justify-center "
                    ...
                    <Empty title="FAQs" class="mb-2" v-motion-fade-visible-once/>
                    <div class="flex">
                        <RoundButton text="+"
                ...
                <section v-else>
                    ...
                    <div class="w-full h-full" v-else-if="!loading && !error">
                        <section class="flex flex-col">
                            <h1 class="text-lg mb- pl-1">FAQs</h1>
                            ...
                            <!-- TABLE -->
                            <FaqsTable v-motion-fade-visible-once/>
                        ...
                        <!-- <PagiNav :totalPages="totalPages" :currentPage="currentPage" :onClick="getFaqs" /> -->
